    ...
    <div className="py-[60px] px-5 w-full min-h-screen bg-[#f1f5f9]">
      <div className="flex justify-between items-center mb-12">
        ...
        <div className="text-xl text-[#717f95]">
          Dashboard / <span className="text-blue-700">Upload Book</span>
        </div>
      </div>
      <Formik initialValues={initialValues} validationSchema={UploadBookSchema}>
        {({
          values,
          isSubmitting,
          isValid,
          ...
          <form onSubmit={(e) => e.preventDefault()} className="w-full py-4">
            <div className="w-full py-4 px-5 grid grid-cols-2 gap-x-4 gap-y-6">
              ...
              <div className="col-span-2">
                <div className="mb-2 block">
                  <Label htmlFor="description" value="Your Book Description" />
                </div>
                <textarea
                  className={`input-primary  ${
...
UploadBook.getLayout = function getLayout(page) {
